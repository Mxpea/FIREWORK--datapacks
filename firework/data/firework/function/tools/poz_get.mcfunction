...
data modify storage firework:lig poz_x set from entity @s Pos[0]
data modify storage firework:lig poz_y set from entity @s Pos[1]
data modify storage firework:lig poz_z set from entity @s Pos[2]