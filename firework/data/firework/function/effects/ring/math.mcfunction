...
execute if score steps rings matches ..0 run tellraw @a {text:"[点击这里设置步数]",color:"yellow",click_event:{action: "suggest_command",command:"/scoreboard players set steps rings "}}
