...
execute unless score @s gu.uuid.0 matches -2147483648.. run function firework:gu/zzz/store_uuid
...
function firework:gu/zzz/get_hexes with storage gu:temp
function firework:gu/zzz/concat_uuid with storage gu:temp